                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="ne_inner_title_nev_wrapper">
                        <ul>
                            ...
                            <li><i class="fa fa-folder-open"></i> Gadgets and Technology</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="ne_recent_left_side_wrapper">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_busness_main_slider_wrapper ne_busness_techo_inner_main_slider_wrapper">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper1">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t1.jpg')}}" alt="img">
                                        <h2>Technology</h2>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t2.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">
                                                Hands on the Apple </a></h3>
                                        <ul class="ne_re_social1_wrapper">
                                            <li data-animation="animated fadeInLeft"><a href="#"><i class="fa fa-calendar"></i> &nbsp;25 OCT, 2020</a>
                                            </li>
                                            <li data-animation="animated fadeInLeft"><a href="#"><i class="fa fa-clock-o"></i> &nbsp;07 : 00 am</a>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t3.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">The clock is ticking </a></h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t4.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t5.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">Black farmers in USA </a></h3>
                                        <ul class="ne_re_social1_wrapper">
                                            <li data-animation="animated fadeInLeft"><a href="#"><i class="fa fa-calendar"></i> &nbsp;25 OCT, 2020</a>
                                            </li>
                                            <li data-animation="animated fadeInLeft"><a href="#"><i class="fa fa-clock-o"></i> &nbsp;07 : 00 am</a>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t6.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t7.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t8.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">Award of the year</a></h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t9.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">Faangs divge prospect</a></h3>
                                        <ul class="ne_re_social1_wrapper">
                                            <li data-animation="animated fadeInLeft"><a href="#"><i class="fa fa-calendar"></i> &nbsp;25 OCT, 2020</a>
                                            </li>
                                            <li data-animation="animated fadeInLeft"><a href="#"><i class="fa fa-clock-o"></i> &nbsp;07 : 00 am</a>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t10.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">Award of the year</a></h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t11.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">Tesla just its head </a></h3>
                                        <ul class="ne_re_social1_wrapper">
                                            <li data-animation="animated fadeInLeft"><a href="#"><i class="fa fa-calendar"></i> &nbsp;25 OCT, 2020</a>
                                            </li>
                                            <li data-animation="animated fadeInLeft"><a href="#"><i class="fa fa-clock-o"></i> &nbsp;07 : 00 am</a>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t12.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">The Clock Is Ticking</a></h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t13.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">Award of the year</a></h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t14.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">Award of the year</a></h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t15.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">The Clock Is Ticking</a></h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_gt_left_top_main_wrapper ne_gt_left_top_main_wrapper2">
                                    <div class="ne_gt_left_img_main_wrapper">
                                        <img src="{{asset('front/images/content/technology/t16.jpg')}}" alt="img">
                                        <h2>gadgets</h2>
                                    </div>
                                    <div class="ne_gt_left_img_cont_main_wrapper">
                                        <h3><a href="#">Easy Teriyaki</a></h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_bottom_banner_main_wrapper ne_bottom_banner_main_wrapper_technologi">
                                    <a href="#">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="pager_wrapper prs_blog_pagi_wrapper ne_pagi_techno">
                                    <ul class="pagination">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ne_sidebar_inner_social_wrapper ne_sidebar_second_inner_social_wrapper">
                                    ...
                                    <div class="ne_la_main_large_img_wrapper">
                                        <img src="{{asset('front/images/content/pc9.jpg')}}" alt="img">
                                    </div>
                                    <div class="ne_re_left_bottom_main_wrapper ne_pc_main_cont_wrapper3">
                                        <div class="ne_pc_bottom_img">
                                            <img src="{{asset('front/images/content/pc6.jpg')}}" alt="rs_img">
