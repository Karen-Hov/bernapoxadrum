                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="ne_inner_title_nev_wrapper">
                        <ul>
                            ...
                            <li><i class="fa fa-folder-open"></i> Life Style</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="ne_re_left_top_main_wrapper">
                                                                <div class="ne_re_left_img_main_wrapper yellow">
                                                                    <img src="{{asset('front/images/content/life_style/lf_1.jpg')}}" alt="img">
                                                                    <h2>style</h2>
                                                                </div>
                                                ...
                                                <div class="item">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="ne_re_left_top_main_wrapper">
                                                                <div class="ne_re_left_img_main_wrapper yellow">
                                                                    <img src="{{asset('front/images/content/life_style/lf_2.jpg')}}" alt="img">
                                                                    <h2>style</h2>
                                                                </div>
                                                                <div class="ne_re_left_img_cont_main_wrapper">
                                                ...
                                                <div class="item">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="ne_re_left_top_main_wrapper">
                                                                <div class="ne_re_left_img_main_wrapper yellow">
                                                                    <img src="{{asset('front/images/content/life_style/lf_3.jpg')}}" alt="img">
                                                                    <h2>style</h2>
                                                                </div>
                                                                <div class="ne_re_left_img_cont_main_wrapper">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper">
                                                <img src="{{asset('front/images/content/life_style/lf2.jpg')}}" alt="img">
                                                <h2>Bussiness</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">Award of the year</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper ne_re_left_img_main_wrapper2">
                                                <img src="{{asset('front/images/content/life_style/lf3.jpg')}}" alt="img">
                                                <h2>sport</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">Award of the year</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper">
                                                <img src="{{asset('front/images/content/life_style/lf4.jpg')}}" alt="img">
                                                <h2>Bussiness</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">The Clock Is Ticking</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper ne_re_left_img_main_wrapper2">
                                                <img src="{{asset('front/images/content/life_style/lf5.jpg')}}" alt="img">
                                                <h2>sport</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper">
                                                <img src="{{asset('front/images/content/life_style/lf6.jpg')}}" alt="img">
                                                <h2>Bussiness</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">Boy's Head Impaled</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper ne_re_left_img_main_wrapper2">
                                                <img src="{{asset('front/images/content/life_style/lf7.jpg')}}" alt="img">
                                                <h2>sport</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper">
                                                <img src="{{asset('front/images/content/life_style/lf8.jpg')}}" alt="img">
                                                <h2>Bussiness</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">Award of the year</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper ne_re_left_img_main_wrapper2">
                                                <img src="{{asset('front/images/content/life_style/lf9.jpg')}}" alt="img">
                                                <h2>sport</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper">
                                                <img src="{{asset('front/images/content/life_style/lf10.jpg')}}" alt="img">
                                                <h2>Bussiness</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">The Clock Is Ticking</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper ne_re_left_img_main_wrapper2">
                                                <img src="{{asset('front/images/content/life_style/lf11.jpg')}}" alt="img">
                                                <h2>sport</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">Easy Teriyaki</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper">
                                                <img src="{{asset('front/images/content/life_style/lf12.jpg')}}" alt="img">
                                                <h2>Bussiness</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">Boy's Head Impaled</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="ne_re_left_top_main_wrapper ne_re_left_top_main_wrapper_lifestyle">
                                            <div class="ne_re_left_img_main_wrapper ne_re_left_img_main_wrapper2">
                                                <img src="{{asset('front/images/content/life_style/lf13.jpg')}}" alt="img">
                                                <h2>sport</h2>
                                            </div>
                                            <div class="ne_re_left_img_cont_main_wrapper">
                                                <h3><a href="#">Award of the year</a></h3>
