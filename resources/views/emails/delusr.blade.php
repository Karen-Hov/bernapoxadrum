                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:560px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="{{asset('site/img/nfl3.png')}}" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr style="border-collapse:collapse">
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0;padding-bottom:5px"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#333333">Հաղորդագրություն</h2></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
{{--                                                            @dd($data)--}}
                                                            <td class="es-m-txt-c" align="left" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">
{{--                                                                    {{isset($data['text'])?$data['text'] : ' '}}</p></td>--}}
                                                            @if(isset($data['text']))
                                                                <p style="color: black">{{$data['text']}}</p>
                                                            @else
                                                                <p style="color: black">ԱՆուն - {{isset($data['name'])?$data['name'] : ' '}}</p>
                                                                <p style="color: black">Էլ. փոստի հասցե - {{isset($data['email'])?$data['email'] : ' ' }}</p>
                                                                <p style="color: black">Հաղորդագրություն  - {{isset($data['messege'])?$data['messege'] : ' ' }}</p>

                                                            @if(isset($data['phone'])) <p style="color: black"> Հեռախոսահամար - {{isset($data['phone'])?$data['phone'] : ' ' }} </p>@endif
                                                            @if(isset($data['website'])) <p style="color: black"> Վեբ կայք - {{isset($data['website'])?$data['website'] : ' ' }} </p>@endif
                                                            @if(isset($data['gender'])) <p style="color: black"> Կատեգորիա - {{isset($data['gender'])?$data['gender'] : ' ' }} </p>@endif

                                                            @if(isset($data['car_id'])) <p style="color: black"> Հայտարարություն - {{isset($data['car_id'])?$data['car_id'] : ' ' }} </p>@endif
                                                            @if(isset($data['linkCV'])) <p style="color: black"> CV հղումը - {{isset($data['linkCV'])?$data['linkCV'] : ' ' }} </p>@endif
                                                            @if(isset($data['file'])) <p style="color: black"><a href="{{isset($data['file'])?asset('storage/uploads/'.$data['file']):''}}" target="_blank">CV Link </a> </p>@endif
