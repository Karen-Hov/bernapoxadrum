...
@section('content')
    <div id="breadcrumb"><a href="{{url('my_admin/')}}">Գլխավոր </a>/ <a href="{{url('my_admin/features/')}}">Հատկություններ </a> / <a href="#">Ավելացնել  </a></div>
            ...
            <div class="col-12">
                <div class="col-12 col-sm-8">
                    ...
                    <div class="card card-primary card-outline card-tabs">
                        ...
                        @endif
                        <form class="form-horizontal" method="POST" action="{{route('features.store')}}" id="form_add"
