...
@section('content')
    <div id="breadcrumb"><a href="{{url('my_admin/')}}">Գլխավոր </a>/ <a href="{{url('my_admin/info/')}}">Տեղեկատվություն </a>
        / <a href="#">Ավելացնել </a></div>
                                    ...
                                    <div class="tab-pane fade @if($loop->first) show active  @endif"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text"
                                                          id=summary-ckeditor_{{$loop->index}} name="content_{{$lang['code']}}"
                                                          class="form-control">{{old('content_'.$lang['code'])}}</textarea>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <input type="file" name="file" class="custom-file-input viewImage"
                                                   id="file-input" accept=".jpeg,.png,.jpg,.png">
