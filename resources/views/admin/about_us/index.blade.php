...
{{--                @dd($about_us->isEmpty())--}}
                @if($about_us)
                    <div class="card-body flex-center">
                        <a href="{{route('about_us.create')}}"> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-primary">
                                Ավելացնել </button></a>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Մեր մասին</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-info btn-sm"
                                       href="{{url('my_admin/about_us/'.$about_us->id.'/edit')}}">
