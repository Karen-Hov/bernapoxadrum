...
@section('content')
    <div id="breadcrumb"><a href="{{url('my_admin/')}}">Գլխավոր </a>/ <a href="{{url('my_admin/about_us/')}}">Մեր մասին </a> / <a href="#">Խմբագրել  </a></div>
            ...
            <div class="col-12">
                <div class="col-12 col-sm-6">
                    ...
                    <div class="card card-primary card-outline card-tabs">
                        ...
                        @endif
                        <form class="form-horizontal" method="post" action="{{url('my_admin/about_us/'.$about_us->id)}}" enctype="multipart/form-data" novalidate="novalidate">
                            @csrf
                            @method('PUT')
{{--                            @dd(config('lang'))--}}
